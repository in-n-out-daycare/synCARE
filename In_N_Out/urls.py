...
urlpatterns = [
    ...
    path('activity_list/food/<int:visit_id>/', views.food, name='food'),
    path('activity_list/food/<int:visit_id>/bottle/', views.bottle, name='bottle'),
    path('activity_list/food/<int:visit_id>/nurse/', views.nurse, name='nurse'),
    path('activity_list/food/<int:visit_id>/lunch/', views.lunch, name='lunch'),
